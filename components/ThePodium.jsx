  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-32 h-32">
        <div className="absolute top-0 right-0 w-1 h-32 bg-linear-to-b from-red-500 via-orange-400 to-transparent rounded-tr"></div>
        <div className="absolute top-0 right-0 w-32 h-1 bg-linear-to-r from-transparent via-orange-400 to-red-500 rounded-tr"></div>
      </div>

      {/* Bottom-left corner border */}
      <div className="absolute bottom-0 left-0 w-32 h-32">
        <div className="absolute bottom-0 left-0 w-1 h-32 bg-linear-to-t from-red-500 via-orange-400 to-transparent rounded-bl"></div>
        <div className="absolute bottom-0 left-0 w-32 h-1 bg-linear-to-r from-red-500 via-orange-400 to-transparent rounded-bl"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        >
          <div className="space-y-6">
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-3xl font-bold text-center tracking-tight text-transparent bg-clip-text bg-linear-to-r from-red-500 via-orange-400 to-yellow-400">
            ...
            <div className="relative mt-6 bg-linear-to-br from-gray-800/70 to-black/70 rounded-2xl p-6 border border-gray-800">
              ...
              <div className="mt-2 relative h-72 w-full overflow-hidden rounded-xl">
                <div className="absolute inset-0 bg-linear-to-br from-black/30 via-black/40 to-black/90 z-10"></div>
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center z-20 p-4">
                  ...
                  <div className="text-center space-y-3">
                    <div className="font-bold text-3xl bg-linear-to-r from-red-500 via-orange-400 to-yellow-400 text-transparent bg-clip-text">
                      {currentNewsletter.month}
                    </div>
                    <div className="text-white font-medium text-lg">
                      Edition {currentNewsletter.edition}
                    </div>
                    <div className="h-px w-16 bg-linear-to-r from-red-500 via-orange-400 to-yellow-400 mx-auto"></div>
                    <div
        ...
        >
          ...
          <div className="bg-black/40 p-6 border-b border-gray-800">
            <div className="flex items-center justify-between">
              ...
              <h2 className="text-xl font-bold text-transparent bg-clip-text bg-linear-to-r from-red-500 via-orange-400 to-yellow-400">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black/80 pointer-events-none opacity-0 hover:opacity-100 transition-opacity duration-300">
                <div className="text-center p-6 bg-black/80 rounded-xl border border-gray-700 max-w-sm">
                  ...
                  <a
                    ...
                    className="inline-block bg-linear-to-r from-orange-600 to-yellow-500 px-4 py-2 rounded-lg text-white font-medium pointer-events-auto hover:from-orange-500 hover:to-yellow-400 transition-all duration-300"
                  >
