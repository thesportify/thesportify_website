...
import { ArrowLeft, CheckCircle, Shield, Calendar, User, Trophy, Loader2, BarChart2, Camera } from 'lucide-react';
...
const RKM_EVENT_PHOTOS = [
  { img: LucknowImg,  city: 'Lucknow'   },
  { img: DelhiImg,    city: 'Delhi'     },
  { img: MumbaiImg,   city: 'Mumbai'    },
  { img: JaipurImg,   city: 'Jaipur'   },
  { img: HydBadImg,   city: 'Hyderabad' },
  { img: KolkataImg,  city: 'Kolkata'   },
  { img: ChennaiImg,  city: 'Chennai'   },
  { img: PatnaImg,    city: 'Patna'     },
];
    ...
    return (
      <div className="h-screen bg-black flex items-center justify-center relative overflow-hidden px-4">
        ...
        >
          ...
          <div className="bg-[#0d0d0d] border border-white/10 rounded-b-2xl shadow-2xl px-5 py-4 text-center">
            ...
            <motion.img
              ...
              src="/RKM2.png"
              alt="RKM 2026"
              className="mx-auto w-12 h-12 object-contain drop-shadow-lg mb-2"
            />
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1 mb-2 rounded-full bg-red-500/15 border border-red-500/30 text-red-400 text-[10px] font-bold tracking-widest uppercase"
            >
            ...
            <motion.p
              ...
              className="text-xs font-semibold text-gray-300 mb-1.5"
            >
            ...
            >
              <span className="flex items-center gap-1.5 px-2.5 py-1 bg-white/5 border border-white/10 rounded-lg text-[10px] text-gray-400">
            ...
            {/* Event Photo Grid - all 8 cities in one row */}
            <motion.div
              initial={{ opacity: 0, y: 8 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              {RKM_EVENT_PHOTOS.map((photo, i) => (
                <div key={i} className="relative aspect-[3/4] rounded-md overflow-hidden">
                  <Image
                    src={photo.img}
                    alt={`${photo.city} - RKM 2026`}
                    fill
                    className="object-cover"
                    sizes="(max-width: 576px) 12vw, 64px"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent" />
                  <p className="absolute bottom-0.5 left-0 right-0 text-center text-white text-[6px] font-semibold px-0.5 leading-tight">
                    {photo.city}
                  </p>
                </div>
              ))}
            ...
            >
              <a
                href="https://rkm-2026-analytics-dashboard.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-[hsl(var(--flame))] to-orange-500 hover:from-orange-500 hover:to-yellow-500 text-black font-bold text-sm shadow-lg hover:shadow-orange-500/30 transition-all duration-300 hover:scale-105"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 text-gray-300 hover:text-white font-semibold text-sm transition-all duration-300"
              >
